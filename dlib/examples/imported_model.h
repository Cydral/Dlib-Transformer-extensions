...
#ifndef DLIB_IMPORTED_QWEN3_0_6B_INSTRUCT_H_
#define DLIB_IMPORTED_QWEN3_0_6B_INSTRUCT_H_

#include <dlib/dnn/decoder_transformer_config.h>

namespace qwen3_0_6b_instruct
{
    // Identity of the imported model, for display and catalog selection.
    static const char* const MODEL_NAME = "Qwen3 0.6B Instruct";
...
namespace imported_model = qwen3_0_6b_instruct;
#endif

#endif // DLIB_IMPORTED_QWEN3_0_6B_INSTRUCT_H_
